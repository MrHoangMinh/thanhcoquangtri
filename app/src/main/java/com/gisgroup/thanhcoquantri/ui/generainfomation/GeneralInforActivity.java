...
public class GeneralInforActivity extends BaseActivity {
  private static String TAG = "GeneralInforActivity";
  ...
  public static Intent newIntent(Context context, boolean isClearTop) {
    ...
    Intent intent = new Intent(context, GeneralInforActivity.class);
    if (isClearTop) {
